...
prj_create -name noelvmp -dev LIFCL-40-7BG400C -impl Impl0 -synthesis "synplify"
# prj_open noelvmp.rdf
...
ldc_set_location -site {M15} [get_ports reset]
ldc_set_location -site {M4} [get_ports duart_tx]
ldc_set_location -site {M7} [get_ports duart_rx]
ldc_set_location -site {E17} [get_ports {gpio[0]}]
ldc_set_location -site {F13} [get_ports {gpio[1]}]
ldc_set_location -site {G13} [get_ports {gpio[2]}]
ldc_set_location -site {F14} [get_ports {gpio[3]}]
