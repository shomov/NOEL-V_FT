...
vcom -novopt -2008 -quiet -work shomov ./../../lib/shomov/nmr_voter.vhd


vcom -novopt -quiet -work gaisler ./../../lib/gaisler/noelv/core/mul64.vhd
vcom -novopt -quiet -work work ./tb_mul.vhd
...
add wave -position insertpoint  \
sim:/tb_mul/mul_fin
add wave -position insertpoint sim:/tb_mul/UUT/*
